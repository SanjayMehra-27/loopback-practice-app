...
declare const LoopbackPracticeAppApplication_base: (new (...args: any[]) => {
    projectRoot: string;
...
export declare class LoopbackPracticeAppApplication extends LoopbackPracticeAppApplication_base {
